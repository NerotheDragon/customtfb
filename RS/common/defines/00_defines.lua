...
NGame = {
	...
	LAG_DAYS_FOR_PAUSE = 105,						-- Days of client lag for pause of gamespeed.
	GAME_SPEED_SECONDS = { 2.0, 0.5, 0.15, 0.05, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NCountry = {
	EVENT_PROCESS_OFFSET = 40,						-- Events are checked every X day per country or state (1 is ideal, but CPU heavy)
...
NTechnology = {
	...
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 6,		-- Base year ahead penalty
...
NBuildings = {
	ANTI_AIR_SUPERIORITY_MULT = 8.0,	-- How much air superiority reduction to the enemy does our AA guns? Normally each building level = -1 reduction. With this multiplier.
...
NAI = {
	...
	DIVISION_DESIGN_MAX_FAILED_DAYS = 30,					-- max days we keep track of since failure of a template design update

	EQUIPMENT_DESIGN_MAX_FAILED_DAYS = 30,					-- max days we keep track of since failure of an equipment design update
